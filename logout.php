...
<head>
     <title> Logout | Complaints Management System - Yaba College of Technology </title>
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    ...
                    if(isset($_SESSION['username'])){
                        ...
                        <div id="success-msg" style='color: #28b779; font-size: 18px; text-align: center;'>Redirecting to login  <meta http-equiv="refresh" content="4; login"></div>
