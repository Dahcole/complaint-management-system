...
<head>
     <title> Profile | Complaints Management System - Yaba College of Technology </title>
                        ...
                        <div class="card">
                          <form class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 control-label col-form-label">Matric No</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="email1" placeholder="<?php echo $matric_no; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div class="border-top">
                                    ...
                                    <p style="font-weight: bold; font-size: 14px;">To edit your profile pls click the link below.</p>
                                        <button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo $base_url;?>edit-profile'"><i class="fa fa-edit"></i> Edit my profile</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    $redirect = $conn->base_url().'profile';
                      ...
                      if(!empty($file_name)){
                        ...
                        if($width == 200 and $height == 200){
                            ...
                            $sql = "UPDATE user SET photo =:photo WHERE username =:username";
                            $conn->query($sql);
