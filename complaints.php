...
<head>
       <title> Complaints | Complaints Management System - Yaba College of Technology </title>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <a href="<?= $base_url ?>add-complaint" class="btn btn-success" style="display: inline-block; margin-bottom: 3px;"> <i class="fa fa-plus"></i> Lodge Complaint</a>
                        <div class="card">
                            <div class="card-body">
                                <?php
                                 $sql = "SELECT COUNT(id) FROM complaints JOIN user on complaints.matric_no = user.matric_no WHERE username =:username";
                                 $conn->query($sql);
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <?php
                                         ...
                                         $sql = "SELECT * FROM complaints JOIN user on complaints.matric_no = user.matric_no WHERE username =:username";
                                         $conn->query($sql);
                                         $conn->bind(':username', $_SESSION['username']);
                                        ...
                                        if($row_count > 0){
                                            ...
                                            ?>
                                            <tr>
                                                <td colspan="7" class="text-center">You don't have any complaints yet, click the button above to add one.</td>
                                            </tr>
                                            <?php
                                        }
                                        ?>
