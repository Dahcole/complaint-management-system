...
<head>
     <title> Admin Messages | Complaints Management System - Yaba College of Technology </title>
...
<?php include 'inc/preloader.php'; ?>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <?php
                $sql = "SELECT * FROM admin_messages JOIN user u on admin_messages.user = u.username ORDER BY id DESC";
                ...
                foreach ($result_set as $messages) {
                    ...
                    <div class="d-flex flex-row comment-row m-t-0">
                        ...
                        <div class="comment-text w-100">
                            <h6 class="font-medium">Sent on behalf of <?php echo $message_sender; ?> for complaint: #<?php echo $complaint_no; ?></h6>
...
if(isset($_POST['mark_read'])){
    ...
    $sql = "UPDATE admin_messages SET is_read =:yes WHERE id =:id";
    $conn->query($sql);
    $conn->bind(":id", $msg_id);
    $conn->bind(":yes", "yes");
