...
<!--                </li>-->
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    <?php
                    $sql = "SELECT * FROM admin_messages JOIN user u on admin_messages.user = u.username
                                 WHERE is_read =:no ORDER BY id DESC LIMIT 3";
                    $conn->query($sql);
                    $conn->bind(":no", "no");
                                ...
                                <div class="">
                                    ...
                                    if($rowCount > 0 ){
                                        foreach ($result_set as $messages){
                                            ...
                                            $redirect = $conn->base_url()."admin/messages";
                                            $msg_id = $messages->id;
                                            ...
                                            <a href="<?php echo $redirect; ?>" class="link border-top">
                                                <div class="d-flex no-block align-items-center p-10">
                                                    ...
                                                    <div class="m-l-10">
                                                        <h5 class="m-b-0">#<?php echo $complaint_no; ?>(<?php echo $message_sender; ?>)</h5>
                                        ...
                                        echo "<p class='text-center'>No new notifications yet. </p>";
                                    }
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated">
                        ...
                        <a class="dropdown-item" href="<?php echo $base_url; ?>admin/change-password"><i class="ti-lock m-r-5 m-l-5"></i>Change Password</a>
                        <div class="dropdown-divider"></div>
