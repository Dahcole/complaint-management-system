...
<head>
      <title> View Complaints | Complaints Management System - Yaba College of Technology </title>
...
<?php include 'inc/preloader.php'; ?>
        ...
        <div class="page-wrapper">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        $sql = "SELECT * FROM complaints JOIN user on complaints.matric_no = user.matric_no
                                                WHERE username =:username AND complaint_number =:complaints_no";
                                        $conn->query($sql);
                                        ...
                                        <div id="Toggle-3" class="collapse multi-collapse">
                                            <div class="card-body widget-content">
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <input type="hidden" name="replied_by" value="<?= $name; ?>">
                                ...
                                <div class="chat-box scrollable" style="height:475px; background: #fbfdff;">
                                    ...
                                    <ul class="chat-list">
                                        ...
                                        $sql = "SELECT * FROM complaint_replies JOIN complaints on complaint_replies.student_id = complaints.studentID
                                                ...
                                                WHERE studentID =:student_id AND complaint_no =:complaint_no";
                                        $conn->query($sql);
                                          ...
                                          foreach ($result_details as $replies){
                                              ...
                                              if($replied_by === $name){
                                                  ...
                                                  <li class="chat-item" style="margin-left: 30px;">
                                                      ...
                                                      $sql = "SELECT photo FROM admin WHERE email =:admin_email";
                                                      $conn->query($sql);
                                                      $conn->bind(":admin_email", $admin_email);
            ...
            if(isset($_POST['submit'])){
                if(!empty($_POST['new_message'])){
                    ...
                    $conn->bind(":username", $user);
                    $insert = $conn->execute();

                    //second query to reopen the complaint in the complaints table.
                    $sql_update_status = "UPDATE complaints SET status = :open, last_modified =:modified WHERE complaint_number =:complaint_no";
                    $conn->query($sql_update_status);
                    $conn->bind(":open", 'Open');
                    $conn->bind(":complaint_no", $complaint_no);
                    $conn->bind(":modified", $date);
                    $update = $conn->execute();
                    ...
                    $conn->query($sql);
                    $conn->bind(":username", $_SESSION['username']);
                    $message_content = "<p>Hello, $admin_name, a new reply have been made to the complaint with complaint no: #$db_complaint_no. Please visit the complaint page for more details.</p>";
                    ...
                    $mail->Subject = "New Complaints Reply Admin";
                    //set sender email
                    $mail->setFrom("admin@yabatechcomplaintsys.com", "Yabatech Complaint Management System ");
                    //enable HTML
                    $mail->isHTML(true);
                 ...
                 <div>
                   ...
                   <p style='text-align: center;'>Please login to your account area to reply to this complaint message. Thanks.</p>
                    <h2 style='font-size: 14px; text-align: center;'>&copy; $year | Yabatech Complaint Management System   | All Rights Reserved </h2>
    ...
    $mail->addReplyTo("$user_email", "Acknowledging Receipt of complaint reply: $name");
    //send the email
    $send_email = $mail->send();

            if ($send_email AND $insert AND $update AND $send_notification) {
                echo "<script>
      toastr['success']('Your complaint reply was submitted successfully. You will get a reply via email as soon as possible.');
